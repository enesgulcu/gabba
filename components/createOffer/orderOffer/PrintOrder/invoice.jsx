    ...
    return <div className="flex flex-col w-fit h-fit gap-6 relative">
        ...
        <div ref={printRef} className="a4">
            ...
            <header className="flex items-start justify-end mb-6">
                <Image src="/Logo.png" width={300} height={300} alt="" className="mr-auto"/>
            ...
            <table className="w-full break-inside-auto">
                ...
                <tr>
                    <th>
                         <span
                             className="text-[10pt] text-[#363B46] font-bold">{langs.invoice[lang]}#</span>
                    </th>
                    <th>
                    ...
                    <th>
                        <div className="flex items-center justify-around">
                            <div className="flex items-center justify-between gap-2">
                                <span
                                    className="text-[10pt] text-[#363B46] font-bold">{langs.teklifNo[lang]}:</span>
                                <span className="text-[10pt] text-[#000] font-bold">{details.order_no}</span>
                            </div>

                            <div className="flex items-center justify-between gap-2">
                                <span
                                    className="text-[10pt] text-[#363B46] font-bold">{langs.date[lang]}:</span>
                                <span
            ...
            <footer className="flex justify-between">
                ...
                <div className="flex flex-col items-end gap-2 mt-[24px]">
                    <div className="flex items-center gap-6 px-1.5 w-[300px]">
                        <span className="text-[#363B46] text-[13pt] font-bold">{langs.total[lang]} :</span>
                        <p className="ml-auto text-[#363B46] text-[12pt] font-bold">{total.total} грн</p>
                    </div>

                    <div className="flex items-center gap-6 px-1.5 w-[300px]">
                        <span className="text-[#363B46] text-[13pt] font-bold">{langs.vergi[lang]} :</span>
                    ...
                    <div className="flex items-center gap-6 w-[300px] bg-[#FFC90B] p-1.5 rounded-sm">
                        <span
                            className="text-[#363B46] text-[13pt] font-bold">{langs.genelToplam[lang]} :</span>
